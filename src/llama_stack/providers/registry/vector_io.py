...
""",
        ...
        InlineProviderSpec(
            ...
            module="llama_stack.providers.inline.vector_io.feast",
            config_class="llama_stack.providers.inline.vector_io.feast.FeastVectorIOConfig",
            api_dependencies=[Api.inference],
...
provider for Llama Stack. It supports multiple online store backends (Milvus, SQLite, pgvector,
